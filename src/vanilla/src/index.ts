...
export default class SelectionArea extends EventTarget<SelectionEvents> {
  public static version = 'ssshooter'
  ...
  _onTapStart(evt: MouseEvent | TouchEvent, silent = false): void {
    ...
    console.log('_onTapStart', target)
    ...
    // patch for mind-elixir
    if (!target.draggable) on(document, ['touchmove', 'mousemove'], this._delayedTapMove, { passive: false })
