...
// https://www.uplabs.com/posts/flat-ui-palette-templates
// 颜色参考
// 添加更多图标
let colorList = [
  '#2c3e50',
...
<use xlink:href="#icon-B"></use>
    ...
    <div class="bof">
    <span class="font">文字</span>
    <span class="background">背景</span>
    </div>
`
tagDiv.innerHTML = `
    标签<input class="nm-tag" tabindex="-1" placeholder="多个标签半角逗号分隔" /><br>
`
iconDiv.innerHTML = `
    图标<input class="nm-icon" tabindex="-1" placeholder="多个图标半角逗号分隔" /><br>
`
