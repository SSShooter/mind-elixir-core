  ...
  menuContainer.onclick = e => {
    ...
    if (e.target.className === "palette") {
      ...
      if (nodeObj.style && nodeObj.style.background)
        menuContainer.querySelector('.palette[data-color="' + nodeObj.style.background + '"]').className =
          "palette nmenu-selected";
      ...
      if (nodeObj.style && nodeObj.style.color)
        menuContainer.querySelector('.palette[data-color="' + nodeObj.style.color + '"]').className =
          "palette nmenu-selected";
    }
  };
  ...
  mind.bus.addListener("selectNode", function (nodeObj) {
    ...
    if (nodeObj.style) {
      if (nodeObj.style.fontSize)
        menuContainer.querySelector('.size[data-size="' + nodeObj.style.fontSize + '"]').className =
          "size size-selected";
