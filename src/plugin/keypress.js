export default function (mind) {
  let key2func = {
    ...
    37: () => {
      ...
      if (mind.currentNode.offsetParent.offsetParent.className === "rhs") mind.selectParent();
    ...
    39: () => {
      ...
      if (mind.currentNode.offsetParent.offsetParent.className === "rhs" || mind.currentNode.nodeObj.root)
        mind.selectFirstChild();
      else if (mind.currentNode.offsetParent.offsetParent.className === "lhs") mind.selectParent();
    },
    33() {
      // pageUp
      mind.moveUpNode();
