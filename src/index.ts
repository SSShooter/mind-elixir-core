...
class MindElixir<M = any> {
  ...
  declare renderSummary: () => void
  declare editSummary: (el: SummarySvg) => void
  declare renderArrow: () => void
  ...
  declare moveUpNode: (el?: Topic<M> | undefined) => Promise<void>
  declare moveDownNode: (el?: Topic<M> | undefined) => Promise<void>
  declare removeNodes: (tpcs: Topic<M>[]) => Promise<void>
  declare moveNodesIn: (from: Topic<M>[], to: Topic<M>) => Promise<void>
  declare moveNodesBefore: (from: Topic<M>[], to: Topic<M>) => Promise<void>
  declare moveNodesAfter: (from: Topic<M>[], to: Topic<M>) => Promise<void>
  declare beginEdit: (el?: Topic<M> | undefined) => Promise<void>
  declare setNodeTopic: (el: Topic<M>, topic: string) => Promise<void>
  declare scrollIntoView: (el: HTMLElement, forceCenter?: boolean) => void
  declare selectNode: (tpc: Topic<M>, isNewNode?: boolean, e?: MouseEvent) => void
  declare selectNodes: (tpcs: Topic<M>[]) => void
  declare unselectNodes: (tpcs: Topic<M>[]) => void
  declare clearSelection: () => void
  declare stringifyData: (data: object) => string
  declare getDataString: () => string
  ...
  declare install: (plugin: (instance: MindElixir<M>) => void) => void
  declare focusNode: (el: Topic<M>) => void
  declare cancelFocus: () => void
  declare initLeft: () => void
  ...
  declare changeTheme: (theme: Theme<M>, shouldRefresh?: boolean) => void
  declare changeCompact: (compact: boolean) => void
  // #endregion GENERATED
...
export type { ItemOperation, OutlinerI18n, OutlinerOptions } from './outliner'
